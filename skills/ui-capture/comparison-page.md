...
When no implementation exists yet, generate `tmp/ref/capture/report.html` instead of `compare.html`. This shows what was captured from the original site only.
...
<head>
  ...
  <style>
    body { background: #0a0a0a; color: #fff; font-family: system-ui; padding: 20px; max-width: 1200px; margin: 0 auto; }
    h1 { border-bottom: 1px solid #333; padding-bottom: 12px; }
    .region-table { width: 100%; border-collapse: collapse; font-size: 13px; margin-bottom: 32px; }
    .region-table th, .region-table td { padding: 8px 12px; border: 1px solid #333; text-align: left; }
    .region-table th { background: #1a1a1a; }
    .trigger-badge { padding: 2px 8px; border-radius: 4px; font-size: 11px; font-weight: 600; }
    ...
    .capture { margin-bottom: 24px; }
    .capture img { max-width: 100%; border: 1px solid #333; border-radius: 4px; }
    .capture video { max-width: 100%; border: 1px solid #333; border-radius: 4px; }
    .cta { background: #1a1a2e; border: 1px solid #333; border-radius: 8px; padding: 16px 24px; margin-top: 32px; }
...
<!-- Fullpage screenshot -->
<h2>Full Page</h2>
<img src="static/ref/fullpage.png" style="max-width:100%">

<!-- Detected regions table -->
<h2>Detected Interactive Regions</h2>
<table class="region-table">
  ...
  <!-- One row per region from regions.json -->
  <tr>
    <td>1</td>
    <td><code>.hero-section</code></td>
    <td><span class="trigger-badge scroll">scroll-driven</span></td>
    <td>opacity 0→1, transform translateY</td>
  </tr>
  <!-- ... -->
</table>
...
<div class="capture">
  ...
  <div style="display:flex;gap:8px">
    <img src="clip/ref/<name>-idle.png" style="flex:1">
    <img src="clip/ref/<name>-active.png" style="flex:1">
  </div>
</div>

<!-- For scroll-driven: show before / mid / after -->
<div class="capture">
  <h3><name> — before / mid / after</h3>
  <div style="display:flex;gap:8px">
    <img src="clip/ref/<name>-before.png" style="flex:1">
    <img src="clip/ref/<name>-mid.png" style="flex:1">
    <img src="clip/ref/<name>-after.png" style="flex:1">
  </div>
</div>

<!-- For mousemove / auto-timer: show video -->
<div class="capture">
  <h3><name> — video</h3>
  <video src="transitions/ref/<name>.webm" controls loop></video>
</div>
